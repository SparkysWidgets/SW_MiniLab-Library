...
#include <MCP3221.h> //we get a executable and linking error (.elf) if we dont include here as well hmmm
...
int I2CadcVRef = 2506; //Measured millivolts of voltage input to ADC (can measure VCC to ground on MinipH for example)
int eCadcVRef = 4989;	//Not sure how much this matter but for accurate readings mine as well measure the VDD input to the ADC

//		I2C address of PHADC, Voltage Ref of PHADC, GAIN of PH Probe Gain Stage, RollingAverage?, 10 reference or 4, and is this version4 hardware?
MINIPH miniph(pHi2cAddress, I2CadcVRef, DEFAULTOPAMPGAIN, true, false, true);
...
void loop()
{
	...
	//Will process any Serial data coming in for commands this is non blocking and should accumulate messages over multiple loops should they
	...
	//Serial.print(pHtemp);
	//Serial.print(" ADCRaw results : ");
	//Serial.println(pHtemp2);
